...
| `Qwen3-30B-A3B-FP8` experimental selective linear refresh | day0-kit NCCL | **PASS** | `day0-qwen30-fp8-selective-update.json`; native `Fp8LinearMethod` uses checkpoint-layout staging and `refresh_derived_state` before copying back saved runtime storage; generation `day0-0ed8ec2d62354a60890ec7478f36471d`; 37,491 tensors, 32,444,792,832 bytes, 52 buckets; strict verifier PASS; H200 `rc=0` |
