...
INPUT_LENS=(128 512 1024 1536 2048)
NUM_PROMPTS_LIST=(1 2 4 8 16 32 64 128 256)
OUTPUT_LENS=(32)
# INPUT_LENS=(2048)
# NUM_PROMPTS_LIST=(256)
# OUTPUT_LENS=(32)
output_dir="/data/tywang/workspace/vllm/benchmarks/benchmark_result/pp_benchmark"
mkdir -p $output_dir
...
for input_len in "${INPUT_LENS[@]}"; do
    for num_prompts in "${NUM_PROMPTS_LIST[@]}"; do
        for output_len in "${OUTPUT_LENS[@]}"; do
            ...
            CUDA_VISIBLE_DEVICES=4,5,6,7 python "$PYTHON_SCRIPT" \
